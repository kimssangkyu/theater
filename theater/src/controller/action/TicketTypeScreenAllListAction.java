...
public class TicketTypeScreenAllListAction implements Action {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			List<String> screenNameList = reservationDao.getTicketTypePossibleScreenList(scheduleViewingDay, scheduleViewingStartTime, theaterName);
