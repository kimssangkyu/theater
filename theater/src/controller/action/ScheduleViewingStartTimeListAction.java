...
public class ScheduleViewingStartTimeListAction implements Action {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			List<String> scheduleViewingStartTimeList = reservationDao.getAllPossibleViewingStartTimeList(scheduleViewingDay, theaterName, movieName);
