...
public class TicketTypeTheaterAllAction implements Action{
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<String> TheaterList = theaterDao.getTicketTypePossibleTheaterList(scheduleViewingDay, scheduleViewingStartTime);
